...
const baiduMapUrl =
  "https://map.baidu.com/search/%E5%8D%97%E4%BA%AC%E5%B8%82%E6%B1%9F%E5%AE%81%E5%8C%BA%E6%B1%A4%E5%B1%B1%E8%A1%97%E9%81%93%E8%8B%A5%E6%B0%B4%E8%B7%AF2%E5%8F%B7";
              ...
              <div className={cx("location-layout")}>
                <article className={cx("location-card")}>
                  ...
                  <ul className={cx("location-list")}>
                    ...
                    <li>页面内为宠物风格示意图，点击地图或按钮可直接打开百度地图导航。</li>
                  ...
                  <a className={cx("btn btn-dark")} href={baiduMapUrl} target="_blank" rel="noopener">
                    百度地图导航
                  </a>
                </article>
                <a
                  className={cx("pet-map-link")}
                  href={baiduMapUrl}
                  target="_blank"
                  rel="noopener"
                  aria-label="点击地图在百度地图中打开门店位置"
                >
                    ...
                    <div className={cx("baidu-map-wrap")}>
                      ...
                      <div className={cx("baidu-map-fallback")} id="baiduMapFallback" hidden>
                        <div>
                          ...
                          <p>请点击地图区域，跳转百度地图查看门店位置。</p>
                        </div>
                      </div>
                    </div>
                    <figcaption>南京市江宁区汤山街道若水路2号 · 点击地图导航</figcaption>
                  </figure>
                </a>
              </div>
            </div>
